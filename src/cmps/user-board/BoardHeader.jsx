...
export function BoardHeader({ board, onUpdateBoard }) {
  ...
  return (
    <div className="board-header">
      ...
      {!isEditBoardTitle && <div className="board-name" onClick={toggleEditGroupTitle}>{board.title}</div>}
      {isEditBoardTitle && <textarea
      ...
      {board.members && (
        <div className="board-members">
          {board.members.map((member, Idx) => {
            ...
            return(
            <div key={member._id} className="member" style={{zIndex: z}}>
      ...
      <div className="board-header-right">
        ...
        <div className="Filter">
          <span className="icon"><BiFilter/></span>
          <span>Filter</span>
        </div>
      </div>
    </div>
